...
include 'connection.php';
   ...
   // echo $day2;
    ...
    while($row = mysqli_fetch_array($result))
      {
        ...
        window.location.replace(\"result.php?user=$user&id=$id\");
  });" ;
      }
    mysqli_close($con);
    //echo $markerResult;
    ...
    $_SESSION['markerResult'] = $markerResult;
    $_SESSION['listenerResult'] = $listenerResult;
    header('Location: home.php#bottomOFThePage');
?>